...
%--------------------------------------------------------------------------
% File     : SET599+3 : TPTP v8.2.0. Released v2.2.0.
% Domain   : Set Theory
% Problem  : X \ Y (= X sym\ Y
